...
const Header = () => {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-dark" style={{ height: '4rem' }}>
        <div className="container-fluid">
          <div className="d-flex align-items-center my-auto ms-3">
            ...
            >
              <option value="INDIA">
                <MdCurrencyRupee style={{color:"white", backgroundColor:"white"}}/> INDIA
              </option>
            ...
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item">
                <NavLink className="nav-link text-white" to="/login">
                 {/* Login */}
                 {localStorage.getItem("ecommerceUser")!=null ?  "Welcome,"+ localStorage.getItem('ecommerceUser').substring(1,localStorage.getItem('ecommerceUser').indexOf('@')): "Login"}
                </NavLink>
              </li>
            </ul>
          </div>
      ...
      <nav className="navbar shadow  sticky-top navbar-expand-lg " style={{backgroundColor:"white",paddingBottom:
        "0px",paddingTop:"0px"
      }}>
      <div className="container-fluid">
