      ...
      <div className="container-fluid mt-5 mb-5" >
        ...
        <div className="row">
          <div className="col-lg-8">
            <section  className="card shadow"style={{ backgroundColor: "white",borderRadius:"1vh"   }}>
            <h3 className="text-left m-1 p-2" style={{fontFamily:"Roboto"}}>Cart Items:</h3>
            {fetchedData.length !== 0 ? (
              <>
                <div className="d-flex justify-content-end mt-3 ">
                <button
                  className="me-5 p-1  btn d-flex  shadow" onClick={()=>{deleteAll()}}
                  style={{ width: "7%" ,border:"2px solid darkred",backgroundColor:"red" , color:"white", height:"60px",alignItems: "center",justifyContent: "center" }}
                >
                ...
                <ul className="list-unstyled ms-2 p-1 fs-5" data-spy="scroll">
                  {fetchedData.length !== 0 ? (
                    fetchedData.map((item, index) => (
                      <p className=" fs-6 card pt-3 d-flex flex-row bg-primary row" style={{alignItems:"center",justifyContent:"center", color:'white',borderColor:"white"}}  key={index}>
                      {/* <span className="fw-bold fs-5 "></span>{" "} */}
                     <p className="col-8"> {item.product.title} </p> <p className="col-1">:</p><p className="col-3"> $
{item.product.price}</p>
              ...
              <p className="fs-7   mb-3" style={{fontFamily:"monospace"}} >
               ...
               <span className="text" style={{fontFamily:"monospace"}} >{(totalAmount==NaN)? 0:totalAmount }</span>
              </p>
